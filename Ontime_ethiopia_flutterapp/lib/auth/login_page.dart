...
// deprecated in minimal UI (kept for potential future use)
  ...
  String _t(String key) => _localizationController.t(key);
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        final lang = _localizationController.language;
        String langLabel;
        switch (lang) {
          case AppLanguage.am:
            langLabel = 'AM';
                ...
                Padding(
                  ...
                  child: Align(
                    ...
                    child: PopupMenuButton<AppLanguage>(
                      ...
                      onSelected: (value) {
                        _localizationController.setLanguage(value);
                      },
                      itemBuilder: (context) => [
                        PopupMenuItem(
                                ...
                                onGoogle: () async {
                                  ...
                                  try {
                                    ...
                                    final result = await service
                                        .signInWithGoogle(signOutFirst: true);
                                      ...
                                      if (code == 404 &&
                                        ...
                                        final confirmed =
                                          ...
                                          builder: (ctx) => AlertDialog(
                                            title: Text(
                                                _t('create_new_account_title')),
                                            content: Text(
                                                _t('create_new_account_body')),
                                            actions: [
                                              TextButton(
                                                onPressed: () =>
                                                    Navigator.of(ctx)
                                                        .pop(false),
                                                child:
                                                    Text(_t('dialog_cancel')),
                                              ),
                                              FilledButton(
                                                onPressed: () =>
                                                    Navigator.of(ctx).pop(true),
                                                child:
                                                    Text(_t('dialog_create')),
                                              ),
                                            ],
                                          ),
                                        );
